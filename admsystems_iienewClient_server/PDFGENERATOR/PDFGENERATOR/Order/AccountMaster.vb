Public Class AccountMaster
    ...
    Public Sub GvInEnq_Bind()
        ...
        txtTotalRecord.Text = DGVActmaster.RowCount
    End Sub
    ...
    Private Sub DGVActmaster_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGVActmaster.CellClick
        Try
    ...
    Private Sub DGVActmaster_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles DGVActmaster.KeyUp
        Try
            If (e.KeyCode = Keys.Down Or e.KeyCode = Keys.Up) Then
                Address_ID = Convert.ToInt64(Me.DGVActmaster.Rows(Me.DGVActmaster.CurrentRow.Index).Cells(0).Value)
                bindAllData()
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
