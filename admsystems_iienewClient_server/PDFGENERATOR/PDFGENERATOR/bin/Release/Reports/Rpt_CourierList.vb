...
Public Class Rpt_CourierList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.Rpt_CourierList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_CourierList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_CourierList = New Rpt_CourierList()
        rpt.Site = Me.Site
        Return rpt
    End Function
