...
Public Class CourierPrint21
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.CourierPrint21.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCourierPrint21
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CourierPrint21 = New CourierPrint21()
        rpt.Site = Me.Site
        Return rpt
    End Function
