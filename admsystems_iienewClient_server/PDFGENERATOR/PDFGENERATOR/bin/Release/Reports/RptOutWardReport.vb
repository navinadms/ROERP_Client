...
Public Class RptOutWardReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.RptOutWardReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptOutWardReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptOutWardReport = New RptOutWardReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
