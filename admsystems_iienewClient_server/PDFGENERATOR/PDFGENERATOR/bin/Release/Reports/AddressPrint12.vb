...
Public Class AddressPrint12
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.AddressPrint12.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAddressPrint12
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AddressPrint12 = New AddressPrint12()
        rpt.Site = Me.Site
        Return rpt
    End Function
