...
Public Class RptInWardReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.RptInWardReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInWardReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInWardReport = New RptInWardReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
