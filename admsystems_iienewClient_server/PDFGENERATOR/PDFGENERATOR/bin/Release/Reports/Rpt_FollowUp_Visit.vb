...
Public Class Rpt_FollowUp_Visit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.Rpt_FollowUp_Visit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_FollowUp_Visit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_FollowUp_Visit = New Rpt_FollowUp_Visit()
        rpt.Site = Me.Site
        Return rpt
    End Function
