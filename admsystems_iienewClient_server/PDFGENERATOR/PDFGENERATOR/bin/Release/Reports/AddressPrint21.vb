...
Public Class AddressPrint21
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.AddressPrint21.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAddressPrint21
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AddressPrint21 = New AddressPrint21()
        rpt.Site = Me.Site
        Return rpt
    End Function
