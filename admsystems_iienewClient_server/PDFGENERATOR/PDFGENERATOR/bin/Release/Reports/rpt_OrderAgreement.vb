...
Public Class rpt_OrderAgreement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rpt_OrderAgreement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_OrderAgreement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_OrderAgreement = New rpt_OrderAgreement()
        rpt.Site = Me.Site
        Return rpt
    End Function
