...
Public Class RptPlantDrawingView
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptPlantDrawingView.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.RptPlantDrawingView.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Fk_Address() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptPlantDrawingView
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPlantDrawingView = New RptPlantDrawingView()
        rpt.Site = Me.Site
        Return rpt
    End Function
