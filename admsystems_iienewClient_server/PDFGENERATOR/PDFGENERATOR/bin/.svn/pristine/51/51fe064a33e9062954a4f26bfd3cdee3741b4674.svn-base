...
Public Class Rpt_Document_Log1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.Rpt_Document_Log.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class CachedRpt_Document_Log1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Document_Log = New Rpt_Document_Log()
        rpt.Site = Me.Site
        Return rpt
    End Function
