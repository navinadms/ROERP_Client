...
Public Class rptExpense_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rptExpense_Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExpense_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExpense_Report = New rptExpense_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
