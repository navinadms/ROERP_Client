...
Public Class rpt_SpareInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rpt_SpareInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SpareInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SpareInvoice = New rpt_SpareInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
