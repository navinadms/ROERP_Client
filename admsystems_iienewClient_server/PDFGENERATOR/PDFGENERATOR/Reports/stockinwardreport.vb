...
Public Class stockinwardreport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.stockinwardreport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedstockinwardreport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As stockinwardreport = New stockinwardreport()
        rpt.Site = Me.Site
        Return rpt
    End Function
