...
Public Class CourierPrint12
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.CourierPrint12.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCourierPrint12
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CourierPrint12 = New CourierPrint12()
        rpt.Site = Me.Site
        Return rpt
    End Function
