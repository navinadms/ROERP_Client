...
Public Class Rpt_PartyOutstanding_New
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_PartyOutstanding_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.Rpt_PartyOutstanding_New.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_PartyOutstanding_New
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_PartyOutstanding_New = New Rpt_PartyOutstanding_New()
        rpt.Site = Me.Site
        Return rpt
    End Function
