...
Public Class rptFollowUpByUser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rptFollowUpByUser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFollowUpByUser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFollowUpByUser = New rptFollowUpByUser()
        rpt.Site = Me.Site
        Return rpt
    End Function
