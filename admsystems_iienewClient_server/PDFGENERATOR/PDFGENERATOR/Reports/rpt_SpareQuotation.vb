...
Public Class rpt_SpareQuotation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rpt_SpareQuotation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SpareQuotation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SpareQuotation = New rpt_SpareQuotation()
        rpt.Site = Me.Site
        Return rpt
    End Function
