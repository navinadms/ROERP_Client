...
Public Class RptFolloupSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.RptFolloupSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptFolloupSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptFolloupSheet = New RptFolloupSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
