...
Public Class rpt_inquiryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ROERPMAIN.rpt_inquiryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_inquiryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_inquiryReport = New rpt_inquiryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
